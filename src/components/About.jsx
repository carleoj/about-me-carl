...
const About = () => {
  return (
    <section id="about" className="about divider">
        ...
        <p>
        As an aspiring full stack web developer, I am eager to empower my skills and creativity through continuous learning experience. I am excited showcase my talents and share my aspirations with everyone especially to the web dev community. I believe that I have the power  to change things for the better.
        </p>
